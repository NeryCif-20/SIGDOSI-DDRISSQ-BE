...
public final class UserErrorMessageKeys {
    ...
    public static final String CUI_PATTERN = "user.cui.pattern";
    public static final String CUI_ALREADY_EXISTS = "user.cui.already-exists";
    public static final String PHONE_NUMBER_PATTERN = "user.phone-number.pattern";
    public static final String PHONE_NUMBER_ALREADY_EXISTS = "user.phone-number.already-exists";
    public static final String STATUS_NOT_ALLOWED = "user.status.not-allowed";
